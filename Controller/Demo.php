...
class Demo extends Controller
{
    ...
    function indexAction($request)
    {
        ...
        $form->addChildren(  $HTMlGenerator->getTextarea('content', 'Content', 'Test', 'Here goes your content', []));
        ...
        $response->setVariable(['features' => $features, 'offset' => Configuration::$OFFSETPATH, 'title' => 'Demo', 'form' => $form->render()]);
        return $response;
